---
title: "Second Chance Review: Concordia — The Best Game You Almost Skipped"
date: 2026-04-19T18:00:00+0100
draft: false
categories:
  - "Board Games"
tags:
  ...
  - "Euro Game"
  - "Hand Management"
description: "Concordia has the worst box art in the BGG top 30, opaque scoring that makes your first game feel pointless, and a theme that screams 'just another Mediterranean trader.' It's also one of the most perfectly designed games ever made. Here's why play three is where it clicks."
ShowToc: true
TocOpen: false
cover:
  image: "images/concordia.jpg"
  alt: "Concordia box art — Mac Gerdts, PD-Verlag"
  caption: "Box art via BoardGameGeek. Published by PD-Verlag / Rio Grande Games."
  relative: true
images:
  - "images/concordia.jpg"
---

There's a running joke in board gaming circles that [Concordia](https://boardgamegeek.com/boardgame/124361) has done more to prove the "don't judge a book by its cover" rule than any game in history. A beige-toned Mediterranean woman gazes serenely from a box that screams "educational software for schools." The back promises trading, colonists, and Roman provinces — a pitch so aggressively bland it could be a tax return themed around classical antiquity.
...
![Concordia box](images/concordia.jpg "Concordia (2013) — designed by Mac Gerdts. BGG rank #29, 8.08 average, weight 2.99.")
...
1. **It gives you an action** — Architect, Prefect, Senator, Mercator, etc.
2. **It scores you points** — each card belongs to a Roman god (Jupiter, Mars, Saturn, etc.) and scores based on a specific dimension of your board position
3. **It shapes your hand** — more cards means more options per Tribune cycle, but also more turns before you get them all back
...
**If you prefer tactical puzzles over strategic arcs,** the game's emphasis on long-term card composition might feel too indirect. Each individual turn is simple. The depth is in the multi-turn planning, the hand-cycle management, the read on other players' strategies. If you want your turns to feel like solving a puzzle, something like [Castles of Burgundy](https://boardgamegeek.com/boardgame/84876) (weight 2.97) might be more your speed.

**If the art genuinely bothers you,** [Concordia Venus](https://boardgamegeek.com/boardgame/256916) exists. It's a standalone reimplementation with significantly better production values, team play options for up to 6 players, and a weight of 3.01. Same brilliant design, nicer package. Currently ranked #104 on BGG with an 8.26 average.

![Concordia Venus box](images/concordia-venus.jpg "Concordia Venus (2018) — the same brilliant design with updated art and team play. BGG rank #104, 8.26 average.")
...
For context, [Ticket to Ride: Europe](https://boardgamegeek.com/boardgame/14996) — a gateway game — weighs 1.92. Concordia is only one weight point heavier and yet plays in the same strategic league as games like [Brass: Birmingham](https://boardgamegeek.com/boardgame/224517) (3.86) or [Terraforming Mars](https://boardgamegeek.com/boardgame/167791) (3.27). It's the most efficient depth-to-weight ratio in modern board gaming.
...
Mac Gerdts — the designer known for the rondel mechanism in games like [Navegador](https://boardgamegeek.com/boardgame/66589) and [Imperial](https://boardgamegeek.com/boardgame/24181) — replaced his signature rondel with the hand-management system, and in doing so created something more elegant than anything in his previous catalogue. The cards *are* the rondel, but you choose the order, and you build it as you go.
